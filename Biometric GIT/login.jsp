    ...
    try {
        ...
        switch (status) {
            ...
            case 2:
                ...
                try {
                    con = DbConnection.getConnection();
                    PreparedStatement ps= con.prepareStatement("insert into register(name, pass, email, dob, gen, phone, state, country, status,photo) values ('" + name + "','" + pass + "','" + Eamil + "','" + dob + "','" + Gender + "','" + phone + "','" + State + "','" + Country + "','No','"+photo+"')");
